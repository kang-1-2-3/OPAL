...
import pandas as pd
from kitti_dataloader_buildingonly import PcMapLocDataset
        ...
        for epoch in range(num_epochs):
            ...
            if if_early_stop:
                ...
                if early_stopping.early_stop:
                    ...
                    if if_send_email:
                        email_body = f"Training has been early stopped.\n\n This is with rotation, no building with lr = {config['training']['lr']} and circle loss v2 with bs={config['training']['batch_size']}\n"
